        ...
        <div className="bg-purple-400/10 max-h-[400px] p-12 rounded-lg">
          <div className="text-center">
            ...
            >
              ...
              Voluptatem pariatur in nemo consectetur repellendus magni ducimus,
              fuga esse non nostrum itaque, inventore veniam iste placeat minus
              vero officiis sit odit.
            </p>
          </div>
          {/* slider */}
