          ...
          >
            ...
            <div className="absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6">
              ...
              <p>
                ...
                Repellendus, voluptatem! Fuga omnis voluptatum quaerat quam illo
                blanditiis aliquam labore officiis, perferendis sit asperiores
                natus aperiam sed corporis animi consectetur similique?
              </p>
            </div>
          </div>
          {/* item */}
